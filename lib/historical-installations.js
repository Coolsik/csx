...
const DEFINITIONS = [
  definition("h22-9af4616", "H22", "9af4616", H22, "92ba7ea6c48b6ef74fbac8132be6d859ec6a470f25ac6745ca4e1607d0f32f55", {
    leaderConfig: LEADER,
...
function definition(id, family, commit, paths, payloadDigest, extra = {}) {
  const receipt = {
    version: "0.1.0",
    scope: "project",
    root: ROOT_TOKEN,
  ...
  return deepFreeze({ id, family, commit, paths, payloadDigest, receipt });
}
...
function configFor(root) {
  const agents = ["csx-explorer", "csx-analyst", "csx-planner", "csx-architect", "csx-critic", "csx-executor", "csx-code-reviewer"];
